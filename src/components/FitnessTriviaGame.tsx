...
interface FitnessTriviaGameProps {
  onBack: () => void;
}

const FitnessTriviaGame = ({ onBack }: FitnessTriviaGameProps) => {
  ...
  const calculatePoints = (isCorrect: boolean, timeToAnswer: number) => {
    ...
    // Base points for advanced questions
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <div className="text-center">
            ...
            <p className="text-muted-foreground">Loading Fitness Trivia...</p>
          </div>
        </div>
      </div>
    );
        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
          <Card className="rounded-3xl border-2 shadow-float">
            <CardHeader className="text-center space-y-4">
              ...
              <CardTitle className="text-3xl font-bold">Trivia Complete!</CardTitle>
                ...
                {questionResults.map((result, index) => (
                  <div key={index} className="flex items-center justify-between p-3 rounded-xl bg-muted/30">
                    ...
                    <div className="flex items-center space-x-4 text-sm text-muted-foreground">
                      ...
                      <Badge variant={result.pointsEarned > 250 ? "default" : "secondary"}>
      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        ...
        <div className="mb-8">
          ...
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
              <h1 className="text-3xl font-bold text-foreground mb-2">Fitness Trivia</h1>
              <p className="text-muted-foreground">Test your advanced fitness and health knowledge</p>
            </div>
...
export default FitnessTriviaGame;